...
class SearchSpace:
    ...
    def generate_search_space_matrix_without_loose_ends(self):
        # Create all possible connectivity patterns
        for iter, adjacency_matrix in enumerate(self.generate_adjacency_matrix_without_loose_ends(upscale=False)):
