...
class Network(nn.Module):
    ...
    def forward(self, input, discrete=False, normalize=False, proj_op_weights=None, proj_output_weights=None, proj_input_weights=None):
