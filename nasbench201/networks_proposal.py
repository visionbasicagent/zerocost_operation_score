...
parser.add_argument('--proj_crit', type=str, default='jacob', choices=['loss', 'acc', 'jacob', 'snip', 'fisher', 'synflow', 'grad_norm', 'grasp', 'jacob_cov','tenas'], help='criteria for projection')
