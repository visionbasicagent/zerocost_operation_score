...
parser.add_argument('--nesterov', action='store_true', default=False, help='using nestrov momentum for SGD')
...
## projection
parser.add_argument('--edge_decision', type=str, default='sgas', choices=['random','reverse', 'order', 'global_op_greedy', 'global_op_once', 'global_edge_greedy', 'global_edge_once', 'sample'], help='used for both proj_op and proj_edge')
parser.add_argument('--proj_crit_normal', type=str, default='acc', choices=['loss', 'acc', 'jacob'])
parser.add_argument('--proj_crit_reduce', type=str, default='acc', choices=['loss', 'acc', 'jacob'])
parser.add_argument('--proj_crit_edge',   type=str, default='acc', choices=['loss', 'acc', 'jacob'])
...
args.save = '{}/{}-search-{}-{}-{}-{}'.format(args.save_path,
    args.dataset, args.save, args.search_space, args.seed, args.pool_size)
